...
import { TIPOS_ANIMALES } from '../constants/pesaje.constants'
import { TipoAnimalCantidad } from '../types'

interface TipoAnimalCounterProps {
  especie: string
  tiposAnimales: TipoAnimalCantidad[]
  onUpdate: (tipos: TipoAnimalCantidad[]) => void
}

export function TipoAnimalCounter({ 
  especie, 
  tiposAnimales, 
  onUpdate 
}: TipoAnimalCounterProps) {
