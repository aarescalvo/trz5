...
import { Settings, Building2, Warehouse, UserCheck, Package, Users, Truck, Beef, DollarSign, Receipt } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs defaultValue="frigorifico" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 lg:grid-cols-10 gap-1 h-auto">
            ...
            <TabsTrigger value="tiposServicio" className="flex items-center gap-1 text-xs md:text-sm px-2 md:px-3">
              <Receipt className="w-4 h-4" />
              <span className="hidden lg:inline">Servicios</span>
            </TabsTrigger>
            <TabsTrigger value="preciosServicio" className="flex items-center gap-1 text-xs md:text-sm px-2 md:px-3">
